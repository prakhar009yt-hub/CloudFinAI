    ...
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Starter Plan */}
          <div className="bg-[#090909] border border-white/5 rounded-sm p-6 flex flex-col">
            ...
            <button className="w-full py-2 border border-white/10 text-[10px] uppercase font-bold text-white/60 rounded-sm hover:text-white transition-colors cursor-not-allowed opacity-50" disabled>
              Current Plan
            </button>
          </div>

          {/* Pro Plan */}
          <div className="bg-[#111] border border-[#00FFC2]/30 rounded-sm p-6 flex flex-col relative overflow-hidden">
            ...
            <button 
              ...
              className="w-full py-2 bg-[#00FFC2]/10 border border-[#00FFC2]/20 text-[10px] uppercase font-bold text-[#00FFC2] rounded-sm hover:bg-[#00FFC2]/20 transition-colors flex items-center justify-center"
            >
          ...
          <div className="bg-[#090909] border border-white/5 rounded-sm p-6 flex flex-col">
            ...
            <button 
              ...
              className="w-full py-2 border border-white/10 text-[10px] uppercase font-bold text-white/60 rounded-sm hover:text-white transition-colors"
            >
              Contact Sales
            </button>
          </div>
        ...
        <div className="mt-8 bg-[#111] border border-white/5 rounded-sm p-6 flex flex-col md:flex-row md:items-center justify-between">
          ...
          <Link href="/billing" className="flex items-center px-4 py-2 bg-white text-black border border-transparent text-[10px] uppercase font-bold rounded-sm hover:bg-white/80 transition-colors whitespace-nowrap">
